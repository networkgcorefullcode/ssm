...
var AlgorithmLabelMap = map[int]string{
	...
	ALGORITM_AES256_OurUsers: LABEL_ENCRYPTION_KEY_AES256,
	ALGORITM_AES128_OurUsers: LABEL_ENCRYPTION_KEY_AES128,
	ALGORITM_DES_OurUsers:    LABEL_ENCRYPTION_KEY_DES,
	ALGORITM_DES3_OurUsers:   LABEL_ENCRYPTION_KEY_DES3,
}
